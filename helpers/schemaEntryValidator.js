    ...
    custom: {
      options: (value) => {
        if (!value.trim()) {
          ...
          throw new Error('La longitud del título debe estar entre 4 y 10 caracteres');
        }
        return true;
      },
    },
    ...
    custom: {
      options: (value) => {
        if (!value.trim()) {
          ...
          throw new Error('La longitud de la descripción debe estar entre 4 y 20 caracteres');
        }
        return true;
      },
    },
